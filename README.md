...
## 4) Enter Y and then enter your Username and Password you had given before and then enter whatever message you want to send to the client
...
## 5) We see that the client which is the iot device recives the message. We can also send the message from the iot device to the client. 
